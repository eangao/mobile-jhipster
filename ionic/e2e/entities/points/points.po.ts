...
export class PointsDetailPage {
  ...
  exerciseInput = element.all(by.css('span')).get(3);

  mealsInput = element.all(by.css('span')).get(4);

  alcoholInput = element.all(by.css('span')).get(5);

  notesInput = element.all(by.css('span')).get(6);
